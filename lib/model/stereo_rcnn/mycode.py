...
class _StereoRCNN(nn.Module):
    ...
    def __init__(self, classes):
        ...
        self.RCNN_loss_dim_orien = 0 # they ought to be deleted
    ...
    def forward(self, im_left_data, im_right_data, im_info, gt_boxes_left, gt_boxes_right,\
        ...
        ## dim_orien_pred, kpts_prob, left_border_prob, right_border_prob

        return rois_left, rois_right, cls_prob, bbox_pred, None, \
               None, None, None, rpn_loss_cls, rpn_loss_bbox_left_right, \
